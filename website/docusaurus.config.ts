...
import remarkSnackPlayer from '@documents-website/remark-snackplayer';
import remarkCodeblockLanguageTitle from '@documents-website/remark-codeblock-language-as-title';
...
const commonDocsOptions: PluginContentDocs.Options = {
  ...
  editUrl: (options => {
    const baseUrl = 'https://github.com/facebook/documents-website/edit/main';
...
const config: Config = {
  future: {
    ...
    // See https://github.com/facebook/documents-website/pull/4268
    // See https://docusaurus.io/blog/releases/3.6
    experimental_faster: (process.env.DOCUSAURUS_FASTER ?? 'true') === 'true',
  },
  title: 'Micro Frontend Banking Platform',
  tagline:
